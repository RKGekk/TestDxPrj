...
BasicEffect::BasicEffect(ID3D11Device* device, const std::wstring& filename) : Effect(device, filename, true) {
	...
	SpotLightVar      = mFX->GetVariableByName("gSpotLight");
...
NormalMapEffect::NormalMapEffect(ID3D11Device* device, const std::wstring& filename) : Effect(device, filename, true) {
	Light1Tech    = mFX->GetTechniqueByName("Light1");
	Light2Tech    = mFX->GetTechniqueByName("Light2");
	Light3Tech    = mFX->GetTechniqueByName("Light3");
...
DisplacementMapEffect::DisplacementMapEffect(ID3D11Device* device, const std::wstring& filename) : Effect(device, filename, true) {
	Light1Tech    = mFX->GetTechniqueByName("Light1");
	Light2Tech    = mFX->GetTechniqueByName("Light2");
	Light3Tech    = mFX->GetTechniqueByName("Light3");
...
void Effects::InitAll(ID3D11Device* device) {
	...
	NormalMapFX			= new NormalMapEffect(device, L"NormalMap.fx");
	DisplacementMapFX	= new DisplacementMapEffect(device, L"DisplacementMap.fx");
}
